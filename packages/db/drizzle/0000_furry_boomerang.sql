...
ALTER TABLE "watched_entries" ADD CONSTRAINT "watched_entries_movie_id_movies_id_fk" FOREIGN KEY ("movie_id") REFERENCES "public"."movies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "watched_entries" ADD CONSTRAINT "watched_entries_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_streaming_services" ADD CONSTRAINT "user_streaming_services_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "watched_user_idx" ON "watched_entries" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "watched_movie_idx" ON "watched_entries" USING btree ("movie_id");--> statement-breakpoint
