...
const Movie: NextPage = () => {
  ...
  if (data) {
    ...
    return (
      <>
        <div className='relative flex h-[580px] w-full items-end overflow-hidden'>
          <Image
          ...
          <div className='absolute inset-0 bg-gradient-to-r from-black to-transparent opacity-[200%]'></div>
