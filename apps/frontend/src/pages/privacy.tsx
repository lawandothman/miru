    ...
    <div className='mx-auto mb-8 max-w-4xl px-20 pt-20 '>
      ...
      <div className='flex flex-col gap-2 text-neutral-400'>
        <p>
          ...
          of information that is collected and recorded by Miru and how we use
          it.
        </p>
        ...
        <p>
          ...
          advertisements and links that appear on Miru, which are sent directly
        ...
        <p>
          ...
          shared and/or collect in Miru. This policy is not applicable to any
