    ...
    <div className='mx-auto max-w-4xl px-20 pt-20'>
      ...
      <div className=' mx-auto flex flex-col gap-8'>
        <p>
          ...
          is sharing the experience with others, and Miru makes it easy to find
          the perfect film for your group.
        </p>
        <p>
          Miru is designed to help you and your friends find the perfect movie
          to watch together. One way we do this is by comparing your watchlists
          and identifying common movies that you both want to see. This can be
          especially helpful if you and your friends have different tastes in
          movies, as it allows you to find a film that you can both agree on.
        </p>
        <p>
      ...
      <div className=' mx-auto flex flex-col gap-8'>
        <p>
          ...
          TMDb is a popular movie database that provides a wealth of information
          on films, including plot summaries, cast and crew lists, and more. We
          utilize their API to provide movie recommendations and information to
          our users, but we are not affiliated with TMDb in any official
          capacity.
        </p>
        <p>
