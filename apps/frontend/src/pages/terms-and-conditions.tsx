    ...
    <div className='mx-auto max-w-4xl px-20 pt-20'>
      ...
      <div className=' mx-auto flex flex-col gap-8'>
        ...
        <ul className='list-inside list-disc'>
          ...
          <li>
            transferring the materials to another person or &ldquo;mirror&rdquo;
        ...
        <p>
          The materials appearing on Miru&apos;s Website may include technical,
          typographical, or photographic errors. Miru will not promise that any
          of the materials in this Website are accurate, complete, or current.
          Miru may change the materials contained on its Website at any time
          without notice. Miru does not make any commitment to update the
          materials.
        </p>
        ...
        <p>
          ...
          of any link does not imply endorsement by Miru of the site. The use of
        ...
        <p>
          Miru may revise these Terms of Use for its Website at any time without
          prior notice. By using this Website, you are agreeing to be bound by
        ...
        <p>
          Any claim related to Miru&apos;s Website shall be governed by the laws
